...
public class MyGdxGame implements ApplicationListener {
	...
	{		
		...
		texture_enemy = new Texture(Gdx.files.internal("data/enemy.png"));
		sprite_enemy = new Sprite(texture_enemy ,128,128);
		sprite_enemy.setPosition(-0.2f,-0.2f);
		sprite_enemy.setSize(0.5f, 0.5f);
